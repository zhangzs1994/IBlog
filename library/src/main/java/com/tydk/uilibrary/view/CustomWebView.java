...
/**
 * @author: zzs
 * @date: 2019-08-12 下午 4:26
 * @description: WebView操作处理相关工具类
 */
public class CustomWebView extends WebView {
     ...
     */
    public void initWebView(WebView webView, final String url, final boolean openWay) {
        initSetting(webView,url);
     ...
     * @param url
     */
    public void initSetting(WebView webView, String url) {
        // 登录西安交通发布，查询交通
