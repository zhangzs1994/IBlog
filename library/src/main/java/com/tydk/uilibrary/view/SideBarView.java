...
public class SideBarView extends View {
    ...
    public SideBarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = typedArray.getDimension(R.styleable.SideBarView_sidebar_text_size, sp2px(DEFAULT_TEXT_SIZE));
        ...
        mTextAlignment = typedArray.getInt(R.styleable.SideBarView_sidebar_text_alignment, TEXT_ALIGN_CENTER);
        typedArray.recycle();
